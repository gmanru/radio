                ...
                <Layout  >
                    ...
                    <Header  style={{backgroundColor :"#6600ff" ,color: "white"}} >Priozersk FM radio</Header>
                        ...
                        <Content>
                            ...
                            {/*The voice spectrum*/}    
                            {showbufferingimg ? <img style= {{height:"80px",width:"65%"}}  src={spectrumNone} alt="Voice spectrum" /> : <img className="spectrum-img-dimensions" src={playing ? spectrumpic : spectrumNone} alt="Voice spectrum" />}
